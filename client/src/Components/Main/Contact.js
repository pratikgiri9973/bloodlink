    ...
    const data = [
        {
            title: "BloodLink related queries, feedback and suggestions", body: [
                ...
                "Cannought garden, front side of bsnl office, Aurangabad,Maharashtra-431001",
                "7219452831",
        ...
        },
        {
            title: "For Administrative queries", body: [
                ...
                "Ministry of Health & Family Welfare,Aurangabad Maharashtra - 431001"
            ]
        },
        { title: "For administrative queries", body: ["Blood Cell, National Health Mission", "Ministry of Health & Family Welfare,Aurangbad Maharashtra - 431001"] }
    ];
    return (
